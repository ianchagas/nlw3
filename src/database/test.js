...
Database.then(async (db) => {
    // inserir dados na tabela
     ...
     await saveOrphanage(db, { 
        ...
        about: "Presta assistência a crianças de 06 a 15 anos que se encontre em situação de risco e/ou vulnerabilidade",
        whatsapp: "9896549846456",
        images: [
